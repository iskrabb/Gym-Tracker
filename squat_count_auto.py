...
# pick axis with largest movement
...
# THIS is the real top reference
top_ref = statistics.mean(standing)

# Use warmup only for depth estimate
bottom_ref = warmup_bottom
motion_range = abs(top_ref - bottom_ref)

# Safety in case calibration range is tiny
if motion_range < 1.5:
    motion_range = 1.5

# Dynamic thresholds relative to real standing posture
